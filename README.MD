...
| **TraceState** | comma delimited key=value string "key=value,key1=value1" | is the new W3C trace context header |
...
> TraceParent example [see w3c ref and examples here](https://www.w3.org/TR/trace-context)
